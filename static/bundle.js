...
/***/ function(module, exports, __webpack_require__) {
	...
	store.dispatch((0, _actions.addEmployee)('Foo Bar'));

	console.log(store.getState());

	store.dispatch((0, _actions.removeEmployee)(1));
...
/***/ function(module, exports) {
	...
	var App = exports.App = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(Company, this.props.company);
	    }
	});

	var Company = exports.Company = React.createClass({
	    displayName: "Company",
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement("input", { name: "name", type: "text", placeholder: "Naziv", defaultValue: this.props.name }),
	                React.createElement("input", { name: "address", type: "text", placeholder: "Adresa", defaultValue: this.props.address }),
	                React.createElement("input", { name: "oib", type: "text", placeholder: "OIB", defaultValue: this.props.oib })
	            ),
	...
	var EmployeeList = exports.EmployeeList = React.createClass({
	    displayName: "EmployeeList",

	    render: function render() {
	        var nodes = this.props.employees.map(function (employee, index) {
	            return React.createElement(Employee, _extends({ key: index }, employee));
	        });
	...
	var Employee = exports.Employee = React.createClass({
...
/***/ function(module, exports, __webpack_require__) {
	...
	function company() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialCompany : arguments[0];
	    var action = arguments[1];
	...
	function employees() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialEmployees : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case _actions.ADD_EMPLOYEE:
	            return state.concat([{ name: action.name }]);
	        case _actions.REMOVE_EMPLOYEE:
	            return state.filter(function (el, idx) {
	...
	exports.default = (0, _redux.combineReducers)({ company: company, employees: employees });
...
/***/ function(module, exports) {
	...
	var addEmployee = exports.addEmployee = function addEmployee(name) {
	    return {
	        type: ADD_EMPLOYEE,
	        name: name
	    };
	...
	var removeEmployee = exports.removeEmployee = function removeEmployee(index) {
	    return {
